...
(function(factory) {
  ...
  function PluginWrapper({ component, props }) {
    return /* @__PURE__ */ jsxRuntime.exports.jsx(ErrorBoundary, { disableReset: true, children: React$1.createElement(component, props) });
  }
  ...
  function ae(e) {
    var t, n, r2, o, s2 = void 0 === e ? w : e, i = s2.options, a = void 0 === i ? w : i, c2 = s2.plugins, u2 = void 0 === c2 ? S : c2, l = new stylis_min(a), d = [], p = function(e2) {
      function t2(t3) {
        if (t3)
          try {
            e2(t3 + "}");
  ...
  var Fe = {};
  function Ye(e, t, n) {
    var o = _(e), i = !xe(e), a = t.attrs, c2 = void 0 === a ? S : a, l = t.componentId, d = void 0 === l ? function(e2, t2) {
    ...
    }(e) : h, v2 = t.displayName && t.componentId ? je(t.displayName) + "-" + t.componentId : t.componentId || d, g2 = o && e.attrs ? Array.prototype.concat(e.attrs, c2).filter(Boolean) : c2, N2 = t.shouldForwardProp;
    ...
    var A, C2 = new oe(n, v2, o ? e.componentStyle : void 0), I2 = C2.isStatic && 0 === c2.length, P = function(e2, t2) {
      return function(e3, t3, n2, r2) {
        var o2 = e3.attrs, i2 = e3.componentStyle, a2 = e3.defaultProps, c3 = e3.foldedComponentIds, l2 = e3.shouldForwardProp, d2 = e3.styledComponentId, h2 = e3.target, p2 = function(e4, t4, n3) {
          void 0 === e4 && (e4 = w);
          ...
          var o3 = pe(), s2 = fe(), i3 = t4 ? e4.generateAndInjectStyles(w, o3, s2) : e4.generateAndInjectStyles(n3, o3, s2);
          return !t4 && r3 && r3(i3), i3;
        }(i2, r2, m, e3.warnTooManyClasses), S2 = n2, b2 = v3.$as || t3.$as || v3.as || t3.as || h2, _2 = xe(b2), N3 = v3 !== t3 ? y({}, t3, {}, v3) : t3, A2 = {};
        for (var C3 in N3)
    ...
    } }), i && hoistNonReactStatics_cjs(A, e, { attrs: true, componentStyle: true, displayName: true, foldedComponentIds: true, shouldForwardProp: true, styledComponentId: true, target: true, withComponent: true }), A;
  }
  var qe = function(e) {
  ...
  function HelloWorld() {
    ...
    if (executor.isLoading)
      return /* @__PURE__ */ jsxRuntime.exports.jsx("h3", { children: "Loading..." });
    if (executor.result)
      return /* @__PURE__ */ jsxRuntime.exports.jsxs("h3", { children: [
        "Dataset size: ",
        executor.result.count
      ] });
    return /* @__PURE__ */ jsxRuntime.exports.jsxs(jsxRuntime.exports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntime.exports.jsx("h1", { children: "Hello, dataset dashboard!" }),
      /* @__PURE__ */ jsxRuntime.exports.jsxs("h2", { children: [
        "You are viewing the ",
        /* @__PURE__ */ jsxRuntime.exports.jsx("strong", { children: dataset.name }),
        " dataset"
      ] }),
      /* @__PURE__ */ jsxRuntime.exports.jsx(Button, { onClick: () => executor.execute(), children: "Count samples" }),
      /* @__PURE__ */ jsxRuntime.exports.jsx(Button, { onClick: onClickAlert, children: "Show alert" })
    ] });
  }
